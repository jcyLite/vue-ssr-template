<template>
  <div class="pot-switch">
    <input class="pot-switch-input" type="checkbox" v-model="checkboxValue" :disabled="disabled">
    <i class="pot-switch-ui"></i>
    <span class="pot-switch-label"><slot></slot></span>
  </div>
</template>

<script type="text/ecmascript-6">
  const COMPONENT_NAME = 'pot-switch'
