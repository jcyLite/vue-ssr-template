<template>
  <div class="pot-slide" ref="slide">
    <div class="pot-slide-group" ref="slideGroup">
      <slot>
        <pot-slide-item
    ...
    <div class="pot-slide-dots" v-if="showDots">
...
<script type="text/ecmascript-6">
  import potSlideItem from './slide-item.vue'
  import BScroll from 'better-scroll'
  import scrollMixin from '../../common/mixins/scroll'
  import deprecatedMixin from '../../common/mixins/deprecated'

  const COMPONENT_NAME = 'pot-slide'
