<template>
  <div class="pot-textarea-wrapper" :class="{'pot-textarea_expanded': expanded, 'pot-textarea_active': isFocus}">
    <textarea
      class="pot-textarea"
    ...
    <span v-if="indicator" v-show="expanded" class="pot-textarea-indicator">{{indicatorConf.remain ? remain : count}}</span>
  </div>
</template>

<script type="text/ecmascript-6">
  const COMPONENT_NAME = 'pot-textarea'
